                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-250px sorting" tabindex="0"
                                        ...
                                        style="width: 801.453px;">Product Name</th>
                                    ...
                                    <th class="min-w-150px sorting sorting_desc" tabindex="0"
                                        aria-controls="kt_ecommerce_category_table" rowspan="1" colspan="1"
                                        aria-label="Category Type: activate to sort column ascending"
                                        style="width: 202.219px;" aria-sort="descending">Top Product</th>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <a href="#"
                                                ...
                                                <span class="symbol-label"
                                                    style="background-image:url({{asset(config('constant.IMG_DIR.MAIN_IMAGE').'/'.$item->main_image)}});"></span>
                                            </a>
                                            <!--end::Thumbnail-->
                                            <div class="ms-5">
                                                <!--begin::Title-->
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{route('product.edit',['id' => encrypt($item->id)])}}"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{route('category.destroy',['id'=>encrypt($item->id)])}}" class="menu-link px-3"
                                                    data-kt-ecommerce-category-filter="delete_row" data-route="{{route('product.destroy',['id'=>encrypt($item->id)])}}">Delete</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu-->
