        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Add customer-->
                    <a href="{{route('hero.create')}}" class="btn btn-primary">Add
                        Hero Slider</a>
                    <!--end::Add customer-->
                </div>
                <!--end::Card toolbar-->
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <a href="#"
                                                ...
                                                <span class="symbol-label"
                                                    style="background-image:url({{asset(config('constant.IMG_DIR.HERO_IMAGE').'/'.$item->image)}});"></span>
                                            </a>
                                            <!--end::Thumbnail-->
                                            <div class="ms-5">
                                                <!--begin::Title-->
                                                <a href="#"
                                                    ...
                                                    data-kt-ecommerce-category-filter="category_name">{{$item->title}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <!--end::Category=-->
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{route('hero.edit',['id' => encrypt($item->id)])}}"
                                                    class="menu-link px-3">Edit </a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{route('hero.destroy',['id'=>encrypt($item->id)])}}" class="menu-link px-3"
                                                    data-kt-ecommerce-category-filter="delete_row" data-route="{{route('hero.destroy',['id'=>encrypt($item->id)])}}">Delete</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu-->
