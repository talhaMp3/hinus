...
==============================-->
         <div class="space-bottom">
             <div class="container">
                 <form method="POST" class="contact-form" action="{{ route('contact.store') }}"
                     data-bg-src="{{ asset('frontend/assets/img/bg/contact_form_bg.png') }}">
                     @csrf
    ...
    <div class="row">
        ...
        <!-- Message Textarea -->
        <div class="form-group col-12">
            <textarea name="message" id="message" cols="30" rows="3" class="form-control @error('message') is-invalid @enderror"
                      placeholder="Type Appointment Note...">{{ old('message') }}</textarea>
