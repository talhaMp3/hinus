            ...
            <div class="row gx-60">
                <div class="col-lg-6">
                    <div class="product-big-img">
                        <div class="img"><img src="{{asset('frontend/assets/img/product/product_details_1_1.jpg')}}" alt="Product Image"></div>
                    </div>
                </div>
                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            ...
                            <a href="#"><img src="{{asset('frontend/assets/img/product/product_thumb_1_1.jpg')}}" alt="Cart Image">Surgery Hands Gloves</a>
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="{{asset('frontend/assets/img/product/product_thumb_1_2.jpg')}}" alt="Cart Image">D-Ribose Drug Medicine</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="{{asset('frontend/assets/img/product/product_thumb_1_3.jpg')}}" alt="Cart Image">CAD Dentistry Prosthesis</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="{{asset('frontend/assets/img/product/product_thumb_1_4.jpg')}}" alt="Cart Image">Surgery Safety Mask</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="{{asset('frontend/assets/img/product/product_thumb_1_5.jpg')}}" alt="Cart Image">Infrared Thermometers</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                    ...
                    <p class="woocommerce-mini-cart__buttons buttons">
                        <a href="cart.html" class=" btn btn-primary wc-forward">View cart</a>
                        <a href="checkout.html" class=" btn btn-primary checkout wc-forward">Checkout</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="widget  ">
                <div class="th-widget-about">
                    <div class="about-logo">
                        <a href="static.html"><img src="{{asset('frontend/assets/img/logo.svg')}}" alt="Mediax"></a>
                    </div>
                ...
                <div class="newsletter-widget">
                    ...
                    <div class="btn-group">
                        <a href="https://play.google.com/" class="img-btn">
                            <img src="{{asset('frontend/assets/img/normal/apple_store.png')}}" alt="icon">
                        </a>
                        <a href="https://play.google.com/" class="img-btn">
                            <img src="{{asset('frontend/assets/img/normal/play_store.png')}}" alt="icon">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto d-inline-block d-lg-none">
                            <div class="header-logo">
                                <a href="static.html"><img src="assets/img/logo-white.svg" alt="Mediax"></a>
                            </div>
                        </div>
...
Hero Area
==============================-->
    <div class="th-hero-wrapper hero-1" id="hero" data-bg-src="{{asset('frontend/assets/img/hero/hero_bg_1_1.jpg')}}">
                    ...
                    <div class="hero-inner">
                        <div class="container">
                            <div class="hero-style1">
                                <span class="hero-subtitle" data-ani="slideinup" data-ani-delay="0.2s">100% Premium Quality Products</span>
                                <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.3s">N95 Surgical Mask</h1>
                                <h2 class="hero-heading" data-ani="slideinup" data-ani-delay="0.4s">Get <span class="text-theme">25%</span> Off, Hurry Up!</h2>
                                <p class="hero-text" data-ani="slideinup" data-ani-delay="0.5s">Using a 5 layers surgical mask, we can protect ourselves from various germs. Everyone should use this 5 layers surgical mask.</p>
                                <a href="about.html" class=" btn btn-primary " data-ani="slideinup" data-ani-delay="0.6s"><i class="fas fa-shopping-cart me-2"></i>Shop Now</a>
                            </div>
                        </div>
                        <div class="hero-img" data-ani="slideinright" data-ani-delay="0.5s">
                            <img src="{{asset('frontend/assets/img/hero/hero_1_1.png')}}" alt="Image">
                        </div>
                    </div>
        ...
        <div class="container z-index-common">
            <div class="row gy-30 justify-content-center">
                <div class="col-xl-4 col-md-6">
                    <div class="offer-card " data-bg-src="{{asset('frontend/assets/img/bg/cta_bg_1_1.jpg')}}">
                        <span class="h6 box-subtitle">GET UP TO 26%</span>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="offer-card " data-bg-src="{{asset('frontend/assets/img/bg/cta_bg_1_2.jpg')}}">
                        <span class="h6 box-subtitle">GET UP TO 20%</span>
                        <h3 class="box-title">Capsule Medicine</h3>
                        <p class="price">$80.00 - <del>$100.00</del></p>
                        <a href="#" class=" btn btn-primary btn-sm style2">Shop Now</a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="offer-card " data-bg-src="{{asset('frontend/assets/img/bg/cta_bg_1_3.jpg')}}">
                        <span class="h6 box-subtitle">GET UP TO 26%</span>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="category-card">
                            <div class="box-icon">
                                <img src="{{asset('frontend/assets/img/icon/category_card_1.png')}}" alt="Image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card">
                            <div class="box-icon">
                                <img src="{{asset('frontend/assets/img/icon/category_card_2.png')}}" alt="Image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card">
                            <div class="box-icon">
                                <img src="{{asset('frontend/assets/img/icon/category_card_3.png')}}" alt="Image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card">
                            <div class="box-icon">
                                <img src="{{asset('frontend/assets/img/icon/category_card_4.png')}}" alt="Image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card">
                            <div class="box-icon">
                                <img src="{{asset('frontend/assets/img/icon/category_card_5.png')}}" alt="Image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card">
                            <div class="box-icon">
                                <img src="{{asset('frontend/assets/img/icon/category_card_6.png')}}" alt="Image">
                            </div>
...
==============================-->
        ...
        <div class="container">
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                ...
                <div class="col-lg-auto">
                    <div class="filter-menu filter-menu-active">
                        <!-- <button data-filter="*" class=" btn btn-primary active" type="button">All Products</button> -->
                        <!-- <button data-filter=".cat1" class=" btn btn-primary" type="button">Medicine</button>
                        <button data-filter=".cat2" class=" btn btn-primary" type="button">Equipment</button>
                        <button data-filter=".cat3" class=" btn btn-primary" type="button">Accessories</button> -->
                    </div>
                </div>
            </div>
            <div class="row gy-40 filter-active">
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat3">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="{{asset('frontend/assets/img/product/product_1_1.jpg')}}" alt="Product Image">
                            <span class="product-tag">Sale!</span>
                        </div>
                        <div class="product-content">
                            <a href="#" class="product-category">Accessories</a>
                            <h3 class="product-title"><a href="#">Surgery Hands Gloves</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat1">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="{{asset('frontend/assets/img/product/product_1_2.jpg')}}" alt="Product Image">
                        </div>
                        <div class="product-content">
                            <a href="#" class="product-category">Medicine</a>
                            <h3 class="product-title"><a href="#">D-Ribose Drug Medicine</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat2">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="{{asset('frontend/assets/img/product/product_1_3.jpg')}}" alt="Product Image">
                        </div>
                        <div class="product-content">
                            <a href="#" class="product-category">Equipment</a>
                            <h3 class="product-title"><a href="#">CAD Dentistry Prosthesis</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat3">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="{{asset('frontend/assets/img/product/product_1_4.jpg')}}" alt="Product Image">
                            <span class="product-tag">Sale!</span>
                        </div>
                        <div class="product-content">
                            <a href="#" class="product-category">Accessories</a>
                            <h3 class="product-title"><a href="#">Surgery Safety Mask</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat3">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="{{asset('frontend/assets/img/product/product_1_5.jpg')}}" alt="Product Image">
                        </div>
                        <div class="product-content">
                            <a href="#" class="product-category">Accessories</a>
                            <h3 class="product-title"><a href="#">Infrared Thermometers</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat2">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="{{asset('frontend/assets/img/product/product_1_6.jpg')}}" alt="Product Image">
                        </div>
                        <div class="product-content">
                            <a href="#" class="product-category">Equipment</a>
                            <h3 class="product-title"><a href="#">Drug Inhaler Nebulizers</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat2 cat1">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="{{asset('frontend/assets/img/product/product_1_7.jpg')}}" alt="Product Image">
                            <span class="product-tag">Sale!</span>
                        </div>
                        <div class="product-content">
                            <a href="#" class="product-category">Medicine</a>
                            <h3 class="product-title"><a href="#">Paracetamol Drug</a></h3>
                            <span class="price">$08.85 -<del>$16.99</del></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat3">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="{{asset('frontend/assets/img/product/product_1_8.jpg')}}" alt="Product Image">
                        </div>
                        <div class="product-content">
                            <a href="#" class="product-category">Accessories</a>
                            <h3 class="product-title"><a href="#">Blood Pressure Machine</a></h3>
                            <span class="price">$30.85</span>
                        </div>
                    </div>
                </div>
	...
	Footer Area
==============================-->
    <footer class="footer-wrapper footer-layout2" data-bg-src="{{asset('frontend/assets/img/bg/footer_bg_2.jpg')}}">
        ...
        <div class="copyright-wrap">
            <div class="container">
                <div class="row gy-2 align-items-center">
                    <div class="col-md-7">
                        <p class="copyright-text">Copyright <i class="fal fa-copyright"></i> 2024 <a href="static.html">Mediax</a>. All Rights Reserved.</p>
                    </div>
                    <div class="col-md-5 text-center text-md-end">
                        <div class="payment-img">
                            <img src="{{asset('frontend/assets/img/normal/payment_methods.png')}}" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
