...
==============================-->
           <div class="overflow-hidden space" id="about-sec">
               <div class="shape-mockup" data-top="0" data-right="0"><img
                       src="{{ asset('frontend/assets/img/shape/pattern_shape_1.png') }}" alt="shape"></div>
               <div class="shape-mockup jump d-none d-xl-none" data-bottom="10%" data-left="2%"><img
                       src="{{ asset('frontend/assets/img/shape/medicine_1.png') }}" alt="shape"></div>
               <div class="container">
                   <div class="row justify-content-center">
                       <div class="col-lg-7 col-md-8">
                           <div class="title-area text-center">
                               <span class="sub-title"><img
                                       src="{{ asset('frontend/assets/img/theme-img/title_icon.svg') }}"
                                       alt="shape">About Our Company</span>
                   ...
                   <div class="row align-items-center">
                       <div class="col-xl-6 mb-30 mb-xl-0">
                           <div class="img-box1">
                               <div class="img1">
                                   <img src="{{ asset('frontend/assets/img/normal/about_1_3.png') }}" alt="About">
                               </div>
                               <div class="about-info style2">
                                   ...
                                   <a href="tel:+16356478965" class="box-link"><i class="fa-solid fa-phone"></i> +163
                                       564 78965</a>
                               </div>
                           </div>
                       </div>
                       <div class="col-xl-6">
                           <div class="ps-xxl-4 ms-xl-2 text-center text-xl-start">
                               <div class="title-area mb-32">
                                   <p class="sec-text mt-n2">A brief statement outlining the purpose and mission of the
                                       clinic. This can include the commitment to patient care, community health, and
                                       any specifical goals for our values.</p>
                               </div>
                               ...
                               <div class="about-video-wrap">
                                   <div class="th-video about-video">
                                       <img src="{{ asset('frontend/assets/img/normal/about_1_4.jpg') }}"
                                           alt="video">
                                       <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"
                                           class="play-btn popup-video"><i class="fas fa-play"></i></a>
                                   </div>
                                   <div class="box-content">
                                       <p class="box-text">We offer flexible appointment scheduling options to
                                           accommodate your busy lifestyle. Whether you prefer to book in advance or
                                           need. Your health and well-being are our top priorities.</p>
                   ...
                   <div class="counter-card-wrap bg-theme2">
                       <div class="counter-card">
                           <h2 class="box-number text-white">
                               <span class="number"><span class="counter-number">69</span>k</span><span
                                   class="plus">+</span>
                           </h2>
                       ...
                       <div class="counter-card">
                           <h2 class="box-number text-white">
                               <span class="number"><span class="counter-number">236</span></span><span
                                   class="plus">+</span>
                           </h2>
                       ...
                       <div class="counter-card">
                           <h2 class="box-number text-white">
                               <span class="number"><span class="counter-number">19</span>k</span><span
                                   class="plus">+</span>
                           </h2>
                       ...
                       <div class="counter-card">
                           <h2 class="box-number text-white">
                               <span class="number"><span class="counter-number">320</span></span><span
                                   class="plus">+</span>
                           </h2>
...
==============================-->
                   ...
                   <div class="row gy-4">
                       <div class="col-xl-3 col-sm-6">
                           <div class="why-feature"
                               data-bg-src="{{ asset('frontend/assets/img/bg/why_feature_bg.png') }}">
                               <div class="box-icon">
                                   <img src="{{ asset('frontend/assets/img/icon/choose_feature_1.svg') }}"
                                       alt="icon">
                               </div>
                       ...
                       <div class="col-xl-3 col-sm-6">
                           <div class="why-feature"
                               data-bg-src="{{ asset('frontend/assets/img/bg/why_feature_bg.png') }}">
                               <div class="box-icon">
                                   <img src="{{ asset('frontend/assets/img/icon/choose_feature_2.svg') }}"
                                       alt="icon">
                               </div>
                       ...
                       <div class="col-xl-3 col-sm-6">
                           <div class="why-feature"
                               data-bg-src="{{ asset('frontend/assets/img/bg/why_feature_bg.png') }}">
                               <div class="box-icon">
                                   <img src="{{ asset('frontend/assets/img/icon/choose_feature_3.svg') }}"
                                       alt="icon">
                               </div>
                       ...
                       <div class="col-xl-3 col-sm-6">
                           <div class="why-feature"
                               data-bg-src="{{ asset('frontend/assets/img/bg/why_feature_bg.png') }}">
                               <div class="box-icon">
                                   <img src="{{ asset('frontend/assets/img/icon/choose_feature_4.svg') }}"
                                       alt="icon">
                               </div>
           ...
           <div class="container z-index-common" data-pos-for="#why-sec" data-sec-pos="top-half">
               <div class="th-video">
                   <img src="{{ asset('frontend/assets/img/normal/video_1.jpg') }}" alt="video">
...
==============================-->
           <section class="space" id="team-sec">
               <div class="container z-index-common">
                   <div class="title-area text-center">
                       <span class="sub-title"><img src="{{ asset('frontend/assets/img/theme-img/title_icon.svg') }}"
                       ...
                       <div class="swiper-wrapper">
                           ...
                           <div class="swiper-slide">
                               <div class="th-team team-card">
                                   <div class="box-img">
                                       <img src="{{ asset('frontend/assets/img/team/team_1_1.jpg') }}"
                                           alt="Team">
                                       <div class="th-social">
                           ...
                           <div class="swiper-slide">
                               <div class="th-team team-card">
                                   <div class="box-img">
                                       <img src="{{ asset('frontend/assets/img/team/team_1_2.jpg') }}"
                                           alt="Team">
                                       <div class="th-social">
                                           <a target="_blank" href="https://facebook.com/"><i
                                                   class="fab fa-facebook-f"></i></a>
                           ...
                           <div class="swiper-slide">
                               <div class="th-team team-card">
                                   <div class="box-img">
                                       <img src="{{ asset('frontend/assets/img/team/team_1_4.jpg') }}"
                                           alt="Team">
                                       <div class="th-social">
                                           <a target="_blank" href="https://facebook.com/"><i
                                                   class="fab fa-facebook-f"></i></a>
                           ...
                           <div class="swiper-slide">
                               <div class="th-team team-card">
                                   <div class="box-img">
                                       <img src="{{ asset('frontend/assets/img/team/team_1_5.jpg') }}"
                                           alt="Team">
                                       <div class="th-social">
                                           <a target="_blank" href="https://facebook.com/"><i
                                                   class="fab fa-facebook-f"></i></a>
                           ...
                           <div class="swiper-slide">
                               <div class="th-team team-card">
                                   <div class="box-img">
                                       <img src="{{ asset('frontend/assets/img/team/team_1_6.jpg') }}"
                                           alt="Team">
                                       <div class="th-social">
                                           <a target="_blank" href="https://facebook.com/"><i
                                                   class="fab fa-facebook-f"></i></a>
                           ...
                           <div class="swiper-slide">
                               <div class="th-team team-card">
                                   <div class="box-img">
                                       <img src="{{ asset('frontend/assets/img/team/team_1_7.jpg') }}"
                                           alt="Team">
                                       <div class="th-social">
                                           <a target="_blank" href="https://facebook.com/"><i
                                                   class="fab fa-facebook-f"></i></a>
                           ...
                           <div class="swiper-slide">
                               <div class="th-team team-card">
                                   <div class="box-img">
                                       <img src="{{ asset('frontend/assets/img/team/team_1_8.jpg') }}"
                                           alt="Team">
                                       <div class="th-social">
                                           <a target="_blank" href="https://facebook.com/"><i
                                                   class="fab fa-facebook-f"></i></a>
...
Cta Area
==============================-->
           <section class="space" data-bg-src="{{ asset('frontend/assets/img/bg/cta_bg_6.jpg') }}">
               <div class="container py-40">
                   <div class="row justify-content-center text-center">
                       <div class="col-lg-10">
                           <h2 class="h1 sec-title text-white"><span class="text-theme">Mediax</span> is Leading &
                               Modern Technologies Hospital</h2>
               ...
               <div class="container">
                   ...
                   <div class="achieve-box-wrap">
                       ...
                       <div class="achieve-box hover-item ">
                           <div class="box-img">
                               <img src="{{ asset('frontend/assets/img/normal/achieve_2.jpg') }}" alt="Image">
                           </div>
                       ...
                       <div class="achieve-box hover-item ">
                           <div class="box-img">
                               <img src="{{ asset('frontend/assets/img/normal/achieve_3.jpg') }}" alt="Image">
                           </div>
...
==============================-->
           <section class="space" id="testi-sec"
               data-bg-src="{{ asset('frontend/assets/img/bg/testi_bg_3.jpg') }}">
               <div class="container">
                       ...
                       <div class="swiper-wrapper">
                           <div class="swiper-slide">
                               <div class="testi-card">
                                   ...
                                   <p class="box-text">“Objectively deploy open-source web-readiness impactful
                                       bandwidth. Compellingly coordinate business deliverables rather equity invested
                                       technologies. Phosfluorescently reinvent maintainable.”</p>
